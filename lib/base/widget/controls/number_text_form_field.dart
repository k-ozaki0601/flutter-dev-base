...
class NumberTextFormField extends FormField<String> {
  NumberTextFormField({
    Key key,
    this.controller,
    String initialValue,
    ...
    ValidationBuilder validationBuilder,
        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            final _NumberTextFormFieldState state =
                field as _NumberTextFormFieldState;
...
class _NumberTextFormFieldState extends FormFieldState<String> {
  ...
  @override
  NumberTextFormField get widget => super.widget as NumberTextFormField;
  ...
  @override
  void didUpdateWidget(NumberTextFormField oldWidget) {
